...
function TeaProduct({
  ...
  return (
    <div className="border-solid border-2 border-lime-600 rounded-2xl bg-gray-200 font-sans">
      ...
      <div>
        <div className="mt-2 ml-3 text-2xl font-bold">{shop}</div>
      ...
      <div className="flex justify-evenly ">
        <button className="h-10 bg-lime-600 mb-4 rounded-2xl w-28 text-white font-semibold hover:bg-lime-400 text-sm md:text-xl">
          預約品茶
        </button>
        <button
