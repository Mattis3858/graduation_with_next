...
<div className="portfolio-simple-footer-container" style={{ justifyContent: 'flex-start', overflowX: 'auto' }}>
        ...
        <div className="portfolio-simple-footer-portfolio-simple-footer" >
          ...
          <div className="portfolio-simple-footer-projects" >
            <div className="portfolio-simple-footer-frame3351" style={{
               gap: '4px',
               display: 'flex',
               alignitems: 'center',
          ...
          <div className="portfolio-simple-footer-content">
            <span className="portfolio-simple-footer-text43 titleh2">
              <span>泡茶準備</span>
            </span>
