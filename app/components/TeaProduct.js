  ...
  return (
    <div className="border-solid border-2 border-lime-600 rounded-2xl mt-5 bg-gray-200 font-sans">
      ...
      <div className="flex justify-evenly ">
        <button className="h-10 bg-lime-600 mb-4 rounded-2xl w-28 text-white font-semibold hover:bg-lime-400 text-sm sm:text-2xl">
          預約品茶
        </button>
        <button className="h-10 bg-lime-600 mb-4 rounded-2xl w-28 text-white font-semibold hover:bg-lime-400 text-md sm:text-2xl">
          購買
        </button>
      </div>
    </div>
